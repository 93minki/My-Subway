...
class B {
  ...
  async cachePut(e, t) {
    ...
    const { cacheName: c, matchOptions: i } = this._strategy,
      ...
      g = h ? await S(o, n.clone(), ["__WB_REVISION__"], i) : null;
    try {
...
const v = "GET",
  m = (a) => (a && typeof a == "object" ? a : { handle: a });
class w {
  constructor(e, t, s = v) {
...
function J(a, e, t) {
  ...
  if (typeof a == "string") {
    ...
    s = new w(c, e, t);
  } else if (a instanceof RegExp) s = new G(a, e, t);
...
se([
  { revision: null, url: "assets/index-BzM0S5Rh.css" },
  { revision: null, url: "assets/index-CDBvbyxI.js" },
  { revision: null, url: "assets/workbox-window.prod.es5-DFjpnwFp.js" },
  { revision: "b0397cbca2567efe35bd76e3aac8e8e3", url: "index.html" },
  { revision: "4ab5bc0e01c683f1914c28e167439de4", url: "favicon.png" },
  { revision: "89bd6b6ba17cf475ae62e3d20ed3c340", url: "robots.txt" },
  {
    revision: "c5939bb50d388f3b2233376c84f8d358",
    url: "icons/app_logo_192.webp",
  },
  {
    revision: "29732293e2912a0230a24bd859c340c0",
    url: "icons/app_logo_512.webp",
  },
  { revision: "ddb14deb97356f54b43fd9434ea4e6c4", url: "manifest.webmanifest" },
]);
self.addEventListener("install", (a) => {
  console.log("Service Worker 설치됨.", a), self.skipWaiting();
});
self.addEventListener("activate", (a) => {
  console.log("Service Worker 활성화됨.", a);
});
self.addEventListener("fetch", (a) => {
  console.log("요청 캐치됨:", a.request.url);
});
self.addEventListener("push", (a) => {
  const e = a.data.json();
  console.log("push data", e);
  const t = e.title || "Fallback Title",
    s = { body: e.body || "Fallback body" };
